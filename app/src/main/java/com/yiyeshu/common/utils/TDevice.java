...
public class TDevice {
    ...
    public static DisplayMetrics getDisplayMetrics() {
        return AppUtils.getAppContext().getResources().getDisplayMetrics();
    }
    ...
    public static boolean isPortrait() {
        return AppUtils.getAppContext().getResources().getConfiguration()
    ...
    public static boolean isTablet() {
        int s = AppUtils.getAppContext().getResources().getConfiguration().screenLayout;
    ...
    public static void gotoMarket(Context context, String pck) {
        if (!isHaveMarket(context)) {
            Toast.makeText(AppUtils.getAppContext(), "你手机中没有安装应用市场！", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public static int getVersionCode() {
        return getVersionCode(AppUtils.getAppContext().getPackageName());
    }
    ...
    public static String getVersionName() {
        try {
            return AppUtils.getAppContext()
                    .getPackageManager()
                    .getPackageInfo(AppUtils.getAppContext().getPackageName(), 0)
                    .versionName;
        } catch (PackageManager.NameNotFoundException ex) {
    ...
    public static void copyTextToBoard(String string) {
        ...
        ClipboardManager clip = (ClipboardManager) AppUtils.getAppContext()
                .getSystemService(Context.CLIPBOARD_SERVICE);
        clip.setText(string);
        Toast.makeText(AppUtils.getAppContext(), "拷贝到剪切板成功", Toast.LENGTH_SHORT).show();
    }
    ...
    public static boolean hasWebView(Context context) {
        if (mHasWebView != null) {
            if (!mHasWebView)
                Toast.makeText(AppUtils.getAppContext(), "Not WebView for you phone", Toast.LENGTH_SHORT).show();
            return mHasWebView;
        }
        try {
